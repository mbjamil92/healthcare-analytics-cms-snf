"""Lightweight Streamlit app to explore SNF quality outputs.

How to run (from repo root):
  streamlit run webapp/app.py

The app will look for default outputs in ../outputs/
or you can upload the CSVs generated by the notebook:
  - snf_multi_year_quality.csv
...
def main() -> None:
    st.title("Ballad SNF Quality Explorer")
